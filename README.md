...
```javascript
import moveProperty from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-move-property@v0.1.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/utils-move-property/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/utils-move-property/actions/workflows/test.yml?query=branch:v0.1.0
